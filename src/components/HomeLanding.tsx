...
function openWhatsApp(planName: string, duration: string, price: number, vpn = false, screens = 1) {
  ...
  window.open(`https://wa.me/447414662070?text=${encodeURIComponent(lines.join("\n"))}`, "_blank");
}
            ...
            <div className="mt-8 flex items-center gap-4 sm:gap-6 flex-wrap">
              <button
                onClick={() => {
                  ...
                  window.open(`https://wa.me/447414662070?text=${encodeURIComponent(msg)}`, "_blank");
                }}
      ...
      <div className="relative rounded-3xl overflow-hidden p-6 md:p-14 text-center glass-card-lg">
        ...
        <div className="relative z-10 max-w-2xl mx-auto space-y-6">
          ...
          <div className="flex items-center justify-center gap-4 bg-white/60 border border-slate-200 rounded-2xl px-5 py-4 max-w-xs mx-auto">
            <img
              src="https://api.qrserver.com/v1/create-qr-code/?size=80x80&data=https://wa.me/447414662070%3Ftext%3DHallo%2C%20ik%20wil%20graag%20een%20IPTV%20pakket%20bestellen."
          ...
          <div className="flex items-center justify-center gap-3 flex-wrap pt-2">
            <button
              onClick={() => window.open(`https://wa.me/447414662070?text=${encodeURIComponent("Hallo, ik wil graag weten hoe ik IPTV kan instellen op mijn apparaat. Kunt u mij helpen met de installatie?")}`, "_blank")}
      ...
      <footer className="-mx-3 sm:-mx-4 md:-mx-8 lg:-mx-10 bg-[#0E0E10] px-3 sm:px-4 md:px-8 lg:px-10 pt-14 pb-28 md:pb-8 space-y-10 mt-8">
        ...
        <div className="grid md:grid-cols-3 gap-10">
          ...
          <div className="space-y-5">
            ...
            {/* WhatsApp CTA */}
            <button
              onClick={() => window.open(`https://wa.me/447414662070?text=${encodeURIComponent("Hallo, ik heb een vraag over goedkopeiptv. Kunt u mij helpen?")}`, "_blank")}
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-3">
              {[
                ...
                <li key={item.label}>
                  <button
                    onClick={() => item.tab ? (onSelectTab(item.tab), window.scrollTo({ top: 0, behavior: "smooth" })) : window.open(`https://wa.me/447414662070?text=${encodeURIComponent("Hallo, ik heb een vraag over goedkopeiptv. Kunt u mij helpen?")}`, "_blank")}
