  ...
  return (
    <header className="fixed top-0 inset-x-0 z-50">
      ...
      <div className="bg-[#E0345F] text-white text-xs font-bold text-center py-1.5 px-4 flex items-center justify-center gap-2">
        ...
        <button
          onClick={() => window.open(`https://wa.me/447414662070?text=${encodeURIComponent("Hallo, ik wil graag gebruik maken van de tijdelijke aanbieding bij goedkopeiptv.")}`, "_blank")}
      ...
      <div className={`transition-colors duration-300 ${scrolled ? "glass-header border-b border-white/10" : "bg-transparent border-b border-transparent"}`}>
        <div className="max-w-6xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between gap-6">
          ...
          <div className="flex items-center gap-2 shrink-0">
            ...
            <button
              onClick={() => window.open(`https://wa.me/447414662070?text=${encodeURIComponent("Hallo, ik wil graag een IPTV pakket bestellen.")}`, "_blank")}
      ...
      <AnimatePresence>
        {menuOpen && (
          ...
          >
            ...
            <button
              onClick={() => { setMenuOpen(false); window.open(`https://wa.me/447414662070?text=${encodeURIComponent("Hallo, ik wil graag een IPTV pakket bestellen.")}`, "_blank"); }}
